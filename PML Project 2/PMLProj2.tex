...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.75]{figures/birchscatterplot.png}
	\caption{30 Images from Cluster Four}
\end{figure}
...
\begin{thebibliography}{1.7} 
	...
	\bibitem[6]{BIRCH}\url{https://en.wikipedia.org/wiki/BIRCH}
	\bibitem[7]{BIRCHskl}\url{https://scikit-learn.org/stable/modules/generated/sklearn.cluster.Birch.html}
\end{thebibliography}
